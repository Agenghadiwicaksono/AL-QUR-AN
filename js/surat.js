...
// judul surat
        ...
        const cardJudulSurat =`
              <strong>${response.nama_latin}- ${response.nama}</strong>
                        ...
                        <p>Arti(${response.arti})</p>
                        <button class="btn btn-primary audio-button-play">
                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" class="bi bi-play-circle-fill" viewBox="0 0 16 16">
    ...
    surat.forEach(s => {
        isiSurat+=`
        <div class="container card text-white bg-success mt-5 mb-4">
        <div class="card-body">
            <p>${s.nomor}</p>
